            ...
            <div class="container theme-container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 logo">
                        <h2 class="logo-title  wow fadeInUp" data-wow-delay="0.2s" > <a href="#"> <img src="{{asset('assets/kenya-eu-flags.png')}}" alt=""> </a> </h2>
                    ...
                    <div class="jevent-wrap">
                        <div class="jevent-content">
                            ...
                            <p class="wow fadeInDown"  data-wow-delay="1.0s">
                                ...
                                Besides the panels on 21 Feb, you can connect with business and government officials from 7th to 28th Feb organising bilateral meetings.
                            </p>
                        </div>
                    </div>
                </div>
