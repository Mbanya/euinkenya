                    ...
                    <div class="jevent-wrap">
                        <div class="jevent-content">
                            ...
                            <p class="wow fadeInDown"  data-wow-delay="1.0s">
                                ...
                                organised by the European Union and the African Union. Firms already operating
                                in Kenya will tell us why they invest there and the opportunities they see ahead. More than 20 CEOs are confirmed and will share their personal experiences with us.
                            </p>
                     </div>
                    </div>
                </div>
                    ...
                    <div class="jevent-wrap">
                        <div class="jevent-content">
                            ...
                            <ul class="wow fadeInDown" data-wow-delay="1.0s">
                                <li>
                                    Listen to key firms and public authorities about investment & business opportunities in Angola.
                                </li>
                                <li>
                                    Pose your questions to each session and get your replies.
                                </li>
                                <li>
                                    If you want a bilateral meeting with a firm or government official, check the matchmaking tool and book your slot. The receiver will be able to meet you on this platform or beyond.
                                </li>
                                <li>
            ...
            <div class="container theme-container">
                ...
                <div class="brands-slider light-bg wow fadeInDown"  data-wow-delay="0.2s">
                    <div id="brands-carousel-slider" class="owl-carousel">
                        ...
                        <div class="item"> <a href="#"> <img src="assets/img/partners/brand-3.png" alt=" "> </a> </div>
                        <div class="item"> <a href="#"> <img src="assets/img/partners/brand-4.png" alt=" "> </a> </div>
                        <div class="item"> <a href="#"> <img src="assets/img/partners/brand-5.png" alt=" "> </a> </div>
                        <div class="item"> <a href="#"> <img src="assets/img/partners/brand-6.png" alt=" "> </a> </div>
                        <div class="item"> <a href="#"> <img src="assets/img/partners/brand-4.png" alt=" "> </a> </div>
                        <div class="item"> <a href="#"> <img src="assets/img/partners/brand-1.png" alt=" "> </a> </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-5">
                        <ul class="nav-tabs secondery-font event-faqs-tabs" role="tablist">
                            ...
                            <li  role="presentation" class="wow fadeInLeft"  data-wow-delay="1.1s">
                                <a aria-expanded="false" href="#faqs-2" role="tab" data-toggle="tab" >  WHAT CAN ANGOLA OFFER TO BUSINESS? </a>
                            </li>
                        ...
                        <div class="tab-content event-faqs">
                            ...
                            <div id="faqs-2" class="tab-pane fade" role="tabpanel">
                                <p class="wow fadeInDown"  data-wow-delay="0.6s">
                                    ...
                                    <strong>Angola is Determined to Attract Investment and Improve its Business Environment</strong>
                                    <br>
    ...
    <footer class="footer">
        ...
        <section id="copy-right" class="space-35">
            <div class="copy-right-bg">
                <div class="container theme-container">
                    <p class="copy-rights wow fadeInUp"  data-wow-delay="0.7s">© 2022 EU in KENYA </p>
                </div>
            </div>
        </section>
        <!-- / Copy Right Ends -->
